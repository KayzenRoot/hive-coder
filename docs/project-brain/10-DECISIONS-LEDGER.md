...
This decision becomes APPROVED only if the CP-0015 promotion candidate and final approval mutation pass exact-head Governance + Desktop Shell and HEDS reports no unresolved HIGH/CRITICAL finding.
