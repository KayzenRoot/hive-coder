...
- **Proven (CANONICAL / `HCODER-CP-0026`, `DEC-030`):** the `hive-release-provenance-v1` contract, its offline fail-closed validator, exact package-subject attestation law, and the protected-release workflow's least-privilege/protection-gate structure. `HCODER_CP_0026_EFFECTIVE` is proven by promotion review `5262643157`, expected-head-protected PR #86 merge `3e209faaa96645555fe3ebcddfa6ea8fed13404b` preserving the reviewed tree, and fresh exact-main Governance `35554327364`, Desktop Shell `35554327412`, Native Package Matrix `35554327449` and Protected Release `35554327398` success.
- **Not yet admitted by the current canonical state:** publisher signing, notarization, stapling, release/tag creation, GitHub Release publication, updater transport, artifact download, install, restart or rollback execution. Packages built today are deliberately unsigned; that is not a security success and those packages are not distributable.
